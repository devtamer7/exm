...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Xirfadeeye Exercises</title>
	...
	<link href="../views/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    ...
    <link href="../views/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
	   <!-- Daterange picker -->
    <link href="../views/vendor/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
    <!-- Clockpicker -->
    <link href="../views/vendor/clockpicker/css/bootstrap-clockpicker.min.css" rel="stylesheet">
    <!-- asColorpicker -->
    <link href="../views/vendor/jquery-asColorPicker/css/asColorPicker.min.css" rel="stylesheet">
    <!-- Material color picker -->
    <link href="../views/vendor/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css" rel="stylesheet">
	
    <!-- Pick date -->
    <link rel="stylesheet" href="../views/vendor/pickadate/themes/default.css">
    <link rel="stylesheet" href="../views/vendor/pickadate/themes/default.date.css">
	<link href="../views/icon.css?family=Material+Icons" rel="stylesheet">
	<!-- Style css -->
