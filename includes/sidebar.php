				...
				<ul class="metismenu" id="menu">
					 <li><a href="index.php" class="" aria-expanded="false">
							...
							<span class="nav-text">Dashboard</span>
					              ...
					              <li><a href="student_dashboard.php" class="" aria-expanded="false">
					                      <i class="fas fa-user-graduate"></i>
					                      <span class="nav-text">Student Dashboard</span>
					                  </a>
					              </li>
					 <li><a href="batches.php" class="" aria-expanded="false">
							<i class="fas fa-graduation-cap"></i>
							<span class="nav-text">Batches List</span>
						</a>
					</li>
                    <li><a href="groups.php" class="ai-icon" aria-expanded="false">
                        <i class="flaticon-381-networking"></i>
                        <span class="nav-text">Groups</span>
                    </a>
                    </li>
                    <li><a href="mentors.php" class="ai-icon" aria-expanded="false">
                    ...
                    <li><a href="admins.php" class="ai-icon" aria-expanded="false">
